...
fn bi_pop<'stor, Sdata, Sexec>(ctxt: &mut Runtime<'stor, Sdata, Sexec>) -> Result<(), Error>
where
    Sdata: Stack<Item = i32>,
    Sexec: ExecStack<'stor, Sdata>,
 {
...
fn bi_cr<'stor, Sdata, Sexec>(ctxt: &mut Runtime<'stor, Sdata, Sexec>) -> Result<(), Error>
where
    Sdata: Stack<Item = i32>,
    Sexec: ExecStack<'stor, Sdata>,
 {
...
pub fn bi_lt<'stor, Sdata, Sexec>(ctxt: &mut Runtime<'stor, Sdata, Sexec>) -> Result<(), Error>
where
    Sdata: Stack<Item = i32>,
    Sexec: ExecStack<'stor, Sdata>,
 {
...
pub fn bi_gt<'stor, Sdata, Sexec>(ctxt: &mut Runtime<'stor, Sdata, Sexec>) -> Result<(), Error>
where
    Sdata: Stack<Item = i32>,
    Sexec: ExecStack<'stor, Sdata>,
 {
...
pub fn bi_retstk_push<'stor, Sdata, Sexec>(ctxt: &mut Runtime<'stor, Sdata, Sexec>) -> Result<(), Error>
where
    Sdata: Stack<Item = i32>,
    Sexec: ExecStack<'stor, Sdata>,
 {
...
pub fn bi_retstk_pop<'stor, Sdata, Sexec>(ctxt: &mut Runtime<'stor, Sdata, Sexec>) -> Result<(), Error>
where
    Sdata: Stack<Item = i32>,
    Sexec: ExecStack<'stor, Sdata>,
 {
...
fn bi_eq<'stor, Sdata, Sexec>(ctxt: &mut Runtime<'stor, Sdata, Sexec>) -> Result<(), Error>
where
    Sdata: Stack<Item = i32>,
    Sexec: ExecStack<'stor, Sdata>,
 {
...
pub fn bi_add<'stor, Sdata, Sexec>(ctxt: &mut Runtime<'stor, Sdata, Sexec>) -> Result<(), Error>
where
    Sdata: Stack<Item = i32>,
    Sexec: ExecStack<'stor, Sdata>,
 {
...
pub fn bi_dup<'stor, Sdata, Sexec>(ctxt: &mut Runtime<'stor, Sdata, Sexec>) -> Result<(), Error>
where
    Sdata: Stack<Item = i32>,
    Sexec: ExecStack<'stor, Sdata>,
 {
...
pub fn bi_retstk_dup<'stor, Sdata, Sexec>(ctxt: &mut Runtime<'stor, Sdata, Sexec>) -> Result<(), Error>
where
    Sdata: Stack<Item = i32>,
    Sexec: ExecStack<'stor, Sdata>,
 {
